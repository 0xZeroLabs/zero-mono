...
const angel1 = ref() as unknown as any;
</script>
<template>
  <div class="min-h-full">
    ...
    <div
      ...
      <div class="max-w-[1536px] uppercase">
        ...
        <div class="w-full flex justify-center items-center">
          <button @click="use" class="bg-[#1e1e1e] w-[168px] h-[48px] border-[0.2px] border-[#fff] m-3 btn">
      ...
      <img src="@/assets/angel.svg" alt="angel"
        class="w-[320px] 2xl:w-[380px] an1 absolute md:bottom-0 -left-[94px] hidden md:block" :draggable="false" />

      <img src="@/assets/angel.svg" alt="angel"
        class="w-[320px] 2xl:w-[400px] an2 -scale-x-100 absolute md:bottom-0 -right-[94px] hidden md:block"
        :draggable="false" />

      <a href="#partners" class="h-fit w-fit">
        <img src="@/assets/arrow.svg" alt="angel"
          class="w-[40px] -scale-x-100 absolute bottom-[4px] md:bottom-[16px] animate-bounce left-0 right-0"
    ...
    <div class="w-full flex justify-center">
      <div
        class="relative w-[94%] lg:w-[80%] in1 rounded-md flex min-h-fit max-h-[720px] justify-center items-center bg-white bg-cover bg-center bg-no-repeat bg-none">
        <div
          class="max-w-[1536px] text-left py-4 min-h-[calc(52vh)] flex flex-col justify-center items-center md:items-start relative font-SpaceGrotesk text-white gap-3 px-10">
          <h1 class="font-SpaceGrotesk font-bold text-[40px] md:text-[70px] capitalize text-center text-black">
            <span class="underline negative">THE</span> <span class="bg-black text-white">MISSION</span>
          </h1>
          <p
            class="font-SpaceGrotesk negative font-normal text-[19px] md:text-[24px] text-center md:text-left max-w-[1536px] text-black">
          ...
          <p
            class="z-20 font-SpaceGrotesk negative font-normal text-[19px] md:text-[24px] text-center md:text-left max-w-[1536px] text-black">
      ...
      <img src="@/assets/Zero-coin.png" alt="Zero-coin"
        class="w-[calc(320px)] absolute hover:opacity-50 in1 -bottom-[770px] z-10 cursor-crosshair ml-[10%] h-fit lg:-left-72 hidden lg:block"
        :draggable="false">
    </div>
    <!-- Solutions -->
    <div id="solutions">
