<template>
    <div>
        <ul class="bg-[#000] min-h-[120px] z-[999] flex flex-col py-5 md:pb-0 justify-between items-center md:items-start px-10 w-full text-white">
        ...
        <div
            class="bg-[#000] min-h-[120px] z-[999] flex flex-col md:pb-0 md:flex-row justify-between items-center px-10 w-full text-white">
